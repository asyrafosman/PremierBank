    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-7">
                ...
                <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Invalid amount" ControlToValidate="txtAmount" MinimumValue="10" MaximumValue="9999" ForeColor="Red"></asp:RangeValidator>
            </div>
        </div>
        <div class="form-group">
            <div class="col-lg-12">
